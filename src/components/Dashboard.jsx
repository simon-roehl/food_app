  ...
  return (
    <main className="dashboard">
      ...
      <section className="dashboard__micros">
        ...
        {showMicros && <div className="dashboard__micros-list">{MICRONUTRIENTS.map(({ key, label, unit }) => <ProgressBar key={key} nutrientKey={key} label={label} unit={unit} current={sumNutrient(entries, key)} goal={100} incomplete={isIncomplete(entries, key)} />)}</div>}
      </section>
